...
def main() -> None:
    ...
    ], [make_stream_output(["✓ All core scientific libraries imported successfully."])]))
    ...
    ax.plot(epochs, loss_eff, "o-", label="EfficientAD Distillation Loss", color="#d95f02", linewidth=2)
    ax.set_xlabel("Epoch")
    ...
    cells.append(make_cell("code", [
        ...
        make_execute_result_output({
            ...
            "text/html": df_results.to_html(classes="dataframe", index=False)
        })
    ]))
    ...
    # Render mock bottles
    titles = [
        "Normal (Bottle 01) - OK", "Normal (Bottle 02) - OK", "Normal (Bottle 03) - OK",
        "Contam (Bottle 04) - FAIL", "Contam (Bottle 05) - FAIL", "Contam (Bottle 06) - FAIL"
    ]
    ...
    plt.suptitle("AutoWeld-Vision Qualitative Defect Anomaly Overlays (RdYlGn_r)", fontsize=14)
    plt.tight_layout()
    ...
    cells.append(make_cell("code", [
        ...
        make_stream_output(["Visualizing 6 weld validation instances with anomaly maps..."]),
    ...
    draw_fp.ellipse([70, 40, 186, 216], fill=(200, 200, 250), outline=(255, 255, 255)) # slightly deformed bottle
    ...
    cells.append(make_cell("code", [
        ...
        make_stream_output(["Worst False Positives and False Negatives under threshold = 0.50:"]),
    ...
    cells.append(make_cell("code", [
        ...
        make_stream_output(["Plotting Precision-Recall curves over varying manufacturing decision thresholds..."]),
    ...
    ax.bar(x + width/2, with_cp, width, label="With CutPaste (Augmented)", color="#1b9e77")
    ax.set_xticks(x)
    ax.set_xticklabels(categories)
    ...
    cells.append(make_cell("code", [
        ...
        make_stream_output(["Ablation: Impact of CutPaste augmentation on Category AUROCs:"]),
