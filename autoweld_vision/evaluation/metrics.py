...
class AdvancedIndustrialMetrics:
    ...
    @staticmethod
    def find_optimal_threshold(labels: np.ndarray, scores: np.ndarray) -> Dict[str, float]:
    ...
    @staticmethod
    def compute_fpr_at_recall(labels: np.ndarray, scores: np.ndarray, target_recall: float = 0.95) -> float:
        """
